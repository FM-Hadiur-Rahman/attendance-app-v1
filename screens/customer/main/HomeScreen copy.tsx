...
const SHOP_LAT = 9.7505996;
const SHOP_LON = 79.9929535;
const CHECKIN_RADIUS = 124.02195484112492;
  ...
  return (
    <>
      <Header
        ...
        position="relative"
        center={{ type: "text", value: "Time Track", color: colors.text }}
      />
        ...
        {!checkedIn ? (
          <>
            <View style={styles.middle}>
              <Image
                ...
                style={styles.icon}
              />
              <Text style={styles.subText}>Ready to start your shift?</Text>
            </View>
          ...
          <View style={{ width: "100%", alignItems: "flex-start" }}>
            ...
            <View style={styles.statusRow}>
              <Text style={{ fontWeight: "600", flex: 1, fontSize: fonts.size.l }}>Current Status</Text>
              <View style={styles.statusBadge(!!checkOutTime)}>
                <Text style={styles.statusText}>
                  {checkOutTime ? "Off Duty" : "On Duty"}
                </Text>
              </View>
            </View>
            ...
            >
              <Text style={styles.popupText}>
                Your work timer will stop, and your shift will be recorded.
              </Text>
              <View style={styles.popupBtnContainer}>
                <Button1
                  ...
                  onPress={() => {
                    ...
                    // // // ✅ Update in WorkHours API
                    // // const updated = updateWorkHour(userId, outTime);
                    // // console.log("✅ WorkHour updated:", updated);
                    // // console.log("All records:", workHours);
                    // // Update API
                    // const updated = updateWorkHour(userId, now);
                    // console.log("✅ WorkHour updated:", updated);
                    const now = new Date();
const outTime = now.toLocaleTimeString("en-GB", { hour12: false });
setCheckOutTime(outTime);
...
console.log("✅ WorkHour updated:", updated);
        ...
        >
          <Text style={styles.popupText}>
            Your work timer will start as soon as you click <Text style={{ color: colors.primary }}>Yes</Text>.
          </Text>
          <View style={styles.popupBtnContainer}>
            <Button1
              text="Yes"
              ...
              onPress={() => {
                ...
                // // ✅ Save to WorkHours API
                // // const saved = addWorkHour(userId, inTime);
                // const saved = addWorkHour(userId, now);
                // console.log("WorkHour saved:", saved);
                // // console.log("All records:", workHours);
                const now = new Date();
setCheckedIn(true);
const inTime = now.toLocaleTimeString("en-GB", { hour12: false }); // hh:mm:ss
setCheckInTime(inTime);
setCheckOutTime(null);
setDuration("--");
