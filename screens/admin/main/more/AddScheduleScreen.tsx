...
export default function AddScheduleScreen(props: { userId?: string; langId?: string; }) {
  ...
  const [initialLocalSchedules, setInitialLocalSchedules] = useState<any[]>([]);
  // UI state
  ...
  const openAddModalForDate = (dataYmd: string, displayYmd?: string) => {
    ...
    if (!selectedStaffId) {
      ...
      showErrorToast(lang.Please_select_staff1 || "Please select staff first");
...
const styles = StyleSheet.create({
  ...
  groupTitle: { color: colors.text, fontWeight: 400, fontSize: fonts.size.m },
  groupSubtitle: { color: colors.search, fontWeight: 400, fontSize: fonts.size.s, marginTop: 6 },
  ...
  modalTitle: { fontSize: fonts.size.l, fontWeight: 400, textAlign: "center", marginBottom: 8 },
  ...
  day_text: { color: colors.primary, fontSize: fonts.size.s, fontWeight: 400 },
  time: {
