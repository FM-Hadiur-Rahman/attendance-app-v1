...
import { getUserById, updateUser, deleteUser, ProfileUser, getUserAttendanceSummary } from "../../../../api/profile";
...
const StaffProfileScreen: React.FC<StaffProfileScreenprops> = () => {
    ...
    const fetchAttendanceSummary = async (staffId: string) => {
        try {
            ...
            const sessions = typeof summary.total_sessions === "number" ? summary.total_sessions : 0;
    ...
    const fetchStaff = useCallback(async (staffId?: string) => {
        ...
        try {
            ...
            if ((user as any)?.profileImage) setProfileImage((user as any).profileImage);
    ...
    const savephonevalidation = async (): Promise<boolean> => {
        ...
        const rule = getPhoneRuleForSelected();
        if (!normalized || normalized.length < rule.min || normalized.length > rule.max) {
            console.warn('phone: normalized length invalid', { normalized, rule });
            setErrors(prev => ({ ...prev, phone: `${lang.Enter_at_least || 'Enter at least'} ${rule.min} ${lang.digits || 'digits'}` }));
            return false;
        }
    ...
    const handleSavePosition = async () => {
        ...
        try {
            ...
            if (res) {
                ...
                try { showSuccessToast?.(lang.positionUpdated); } catch { }
            }
        } catch (err: any) {
    ...
    const handleSaveEmail = async () => {
        ...
        try {
            ...
            if (res) {
                ...
                try { showSuccessToast?.(lang.emailUpdated); } catch { }
            }
        } catch (err: any) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            try { showSuccessToast?.("Staff deleted"); } catch { }
    ...
    const parsePhoneForInput = (phone?: string) => {
        ...
        const sorted = [...countryList].sort((a, b) => b.code.length - a.code.length);
    ...
    const handleSavePhone = async () => {
        ...
        try {
            ...
            if (!normalized) {
                Alert.alert("Validation", lang.phone_required || "Phone cannot be empty");
                return;
            }
            ...
            if (res) {
                ...
                setCurrentUser(prev => ({ ...(prev ?? {}), phone: phoneWithCode } as any));
    ...
    return (
        <>
            ...
            >
                <CartBox alignItems="center" backgroundColor={colors.secondary} borderRadius={0}>
                        ...
                        <View style={styles.profileImageContainer}>
                            <View style={styles.profileImageContainer1}>
                                {profileImage ? (
                                    ...
                                    <Image source={require("../../../../assets/icons/profile_gray.png")} style={styles.image} />
                                )}
                            </View>
                            <TouchableOpacity style={styles.editIconContainer} onPress={() => setModalVisible(true)}>
                                <Image source={require("../../../../assets/icons/p_edit.png")} style={styles.editIcon} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </CartBox>
                ...
                <View style={styles.statsContainer}>
                    ...
                    <CartBox paddingVertical={16} paddingHorizontal={10} backgroundColor={colors.background} borderRadius={16} containerStyle={styles.statBox}>
                ...
                >
                    ...
                    <TouchableOpacity activeOpacity={0.7} onPress={() => setPositionModalVisible(true)} style={{ marginBottom: 12, paddingHorizontal: 12 }}>
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 5 }}>
                            <Image source={require("../../../../assets/icons/p_position_b.png")} style={styles.icon} />
                    ...
                    <TouchableOpacity activeOpacity={0.7} onPress={() => setEmailModalVisible(true)} style={{ marginBottom: 15, paddingHorizontal: 12 }}>
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 5 }}>
                            <Image source={require("../../../../assets/icons/p_email_b.png")} style={styles.icon} />
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: '100%' }}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    if (!toEmail) return;
                                    Linking.openURL(`mailto:${toEmail}?subject=${subject}&body=${body}`).catch(err => console.log("Failed to open email app:", err));
                                }}
                            >
                    ...
                    <TouchableOpacity activeOpacity={0.7} onPress={() => setPhoneModalVisible(true)} style={{ marginBottom: 0, paddingHorizontal: 12 }}>
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 5 }}>
                            <Image source={require("../../../../assets/icons/p_phone_b.png")} style={styles.icon} />
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: '100%' }}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    const phoneNumber = (currentUser.phone as string).replace(/\s+/g, "");
                                    Linking.openURL(`tel:${phoneNumber}`).catch(err => console.log("Failed to open dialer:", err));
                                }}
                            >
                ...
                <CartBox
                    ...
                    paddingVertical={20}
                    paddingHorizontal={20}
                    containerStyle={{ alignSelf: "center", marginBottom: 12, height: 165 }}
                    alignItems="flex-start"
                    justifyContent="flex-start"
                >
                    ...
                    <View style={{ marginBottom: 0, paddingHorizontal: 12 }}>
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 5 }}>
                            <Image source={require("../../../../assets/icons/lock_b.png")} style={styles.icon} />
            ...
            {/* Position Modal */}
            <Modal animationType="slide" transparent visible={positionModalVisible} onRequestClose={() => setPositionModalVisible(false)}>
                ...
                <View style={styles.modalContainer}>
                    ...
                    <InputBox label="Position" value={positionInput} setValue={setPositionInput} placeholder="Enter position" />
                    <Button1 text={lang.save} width="100%" onPress={handleSavePosition} disabled={saving} />
                </View>
            </Modal>
                ...
                <View style={styles.modalContainer}>
                    ...
                    <InputBox
                        ...
                        setValue={(text) => {
                            ...
                            if (!formatted.includes("@")) setEmailError("Enter a valid email");
                            else setEmailError("");
                        }}
                        placeholder="Enter email"
                        errorMessage={emailError}
                    />
                    <Button1 text={lang.save} width="100%" onPress={handleSaveEmail} disabled={saving} />
                </View>
            </Modal>

            {/* Phone Modal */}
            <Modal animationType="slide" transparent visible={phoneModalVisible} onRequestClose={() => setPhoneModalVisible(false)}>
                ...
                <View style={styles.modalContainer}>
                                ...
                                onSelect: (item: any) => {
                                    ...
                                    if (!normalized || normalized.length === 0) {
                                        ...
                                        if (newRule.min === newRule.max) {
                                            ...
                                            setErrors(prev => ({ ...prev, phone: `${lang.Enter_at_least || 'Enter at least'} ${newRule.min} ${lang.digits || 'digits'}` }));
                                        }
                                    } else {
                                        setErrors(prev => ({ ...prev, phone: '' }));
                                    }
                    ...
                    />
                    <Button1 text={lang.save} width="100%" onPress={handleSavePhone} disabled={saving} />
                </View>
            </Modal>
            ...
            <Modal animationType="slide" transparent visible={modalVisible}>
                ...
                <View style={styles.modalContainer}>
                    ...
                    <TouchableOpacity style={styles.modalOption} onPress={openCamera} activeOpacity={0.7}>
                        <Image source={require("../../../../assets/icons/p_camera.png")} style={styles.modalIcon} />
                    ...
                    <TouchableOpacity style={styles.modalOption} onPress={openGallery} activeOpacity={0.7}>
                        <Image source={require("../../../../assets/icons/p_gallery.png")} style={styles.modalIcon} />
                        <Text style={styles.modalOptionText}>{lang.gallery}</Text>
                    </TouchableOpacity>
                </View>
            </Modal>

            <Popup visible={deletePopupVisible} onClose={() => setDeletePopupVisible(false)} popupBorderColor={colors.primary} dismissOnOverlayPress={false} title={lang.deleteStaffRecord} titleStyle={{ color: colors.primary }}>
                <Text style={styles.popupsubtext}>
                    {lang.confirmDeleteStaff}
                </Text>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                    <Button1 text={lang.yes} onPress={handleDelete} backgroundColor={colors.primary} width={'48%'} textStyle={{ color: colors.secondary }} />
                    <Button1 text={lang.no} onPress={() => setDeletePopupVisible(false)} backgroundColor={colors.error_text} width={'48%'} textStyle={{ color: colors.secondary }} />
                </View>
            </Popup>
